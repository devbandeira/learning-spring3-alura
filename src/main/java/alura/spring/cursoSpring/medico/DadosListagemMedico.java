...
public record DadosListagemMedico(String nome, String email, String crm, Especialidade especialidade) {//coloquei apenas os campos que quero devolver para o front end
